...
test_that("cdfPlot.R: cdfPlot()", {
    ...
    expect_s3_class(plot_with_aes$viewport, c("canvasXpress", "htmlwidget"))
    ...
    expect_s3_class(plot_with_aes$viewport, c("gg", "ggplot"))
    ...
    expect_setequal(plot_with_aes$viewport$labels$title, "Sub plot title")
    ...
    expect_s3_class(cdf_plot$viewport, c("canvasXpress", "htmlwidget"))
    ...
    expect_s3_class(cdf_plot$viewport, c("gg", "ggplot"))
