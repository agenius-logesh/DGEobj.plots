...
test_that("comparePlot.R: comparePlot()", {
    ...
    cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), colorBySigMeasure = FALSE)
    expect_s3_class(cPlot , c("canvasXpress", "htmlwidget"))
    ...
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), colorBySigMeasure = "123"),
                   regexp = msg)
    expect_s3_class(cPlot , c("canvasXpress", "htmlwidget"))
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), plotType = "ggplot", colorBySigMeasure = "123"),
                   regexp = msg)
    expect_s3_class(cPlot , c("gg", "ggplot"))
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), colorBySigMeasure = c(TRUE, TRUE)),
                   regexp = msg)
    expect_s3_class(cPlot , c("canvasXpress", "htmlwidget"))
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), plotType = "ggplot", colorBySigMeasure = c(TRUE, TRUE)),
                   regexp = msg)
    expect_s3_class(cPlot , c("gg", "ggplot"))
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), colorBySigMeasure = NULL),
                   regexp = msg)
    expect_s3_class(cPlot , c("canvasXpress", "htmlwidget"))
    expect_warning(cPlot <- comparePlot(dgeObj = t_obj1, contrasts = c("BDL_vs_Sham", "EXT1024_vs_BDL"), plotType = "ggplot", colorBySigMeasure = NULL),
                   regexp = msg)
    expect_s3_class(cPlot , c("gg", "ggplot"))
    ## pThreshold
