...
test_that("volcanoPlot.R: volcanoPlot()", {
    ...
    expect_warning(volcanoPlot(DGEdata  = t_obj1,
                               contrast = "BDL_vs_Sham",
                               plotType = "xyz"),
                   regexp = msg)
    ...
    ## foldChangeLines
    msg <- "foldChangeLines must be a singular numeric value. Assigning default value 1.5."
    expect_warning(volcanoPlot(DGEdata  = t_obj1,
                               contrast = "BDL_vs_Sham",
                               foldChangeLines = NULL),
                   regexp = msg)
